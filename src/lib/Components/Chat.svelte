<script>
  ...
  function updateContextInfo() {
    ...
    contextInfo = {
      totalTokens,
      limit: modelContextLimits[selectedModel] || 8192, // Use default if model not found
      remaining: (modelContextLimits[selectedModel] || 8192) - totalTokens
    };
  }
